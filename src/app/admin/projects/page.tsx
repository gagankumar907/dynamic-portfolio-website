  ...
  const openForm = (project?: Project) => {
    if (project) {
      ...
      setFormData({
        ...
        technologies: typeof project.technologies === 'string' ? parseJSON(project.technologies, []) : project.technologies || [],
        images: typeof project.images === 'string' ? parseJSON(project.images, []) : project.images || [],
